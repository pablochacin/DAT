...
public final class Tag {
	...
	// Linear Walker
	public final static Tag REQ_SUCC_AND_PRED = new Tag("REQ_SUCC_AND_PRED");
	public final static Tag REP_SUCC_AND_PRED = new Tag("REP_SUCC_AND_PRED");
	...
	// Pastry
	public final static Tag JOINED = new Tag("JOINED");
	...
	// FRT-Chord
	public final static Tag REQ_STICKY_NODES = new Tag("REQ_STICKY_NODES");
	public final static Tag REP_STICKY_NODES = new Tag("REP_STICKY_NODES");
